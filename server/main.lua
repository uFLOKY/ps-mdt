...
RegisterNetEvent("ps-dispatch:server:deleteCall")
AddEventHandler("ps-dispatch:server:deleteCall", function(callId)
    print("All calls before deletion:")
    ...
    for i, call in pairs(calls) do
        if call.id == callId then
            ...
            TriggerClientEvent("callDeleted", -1, true)
            print("Call with ID " .. callId .. " has been deleted.")
            return
        end
    end
    TriggerClientEvent("callDeleted", -1, false)
    print("Call with ID " .. callId .. " was not found.")
end)
